 ...
 */
#define IconImageName @"TextFieldValidator.bundle/error@2x.png"
 ...
 */
#define MsgValidateLength @"This field is required"//This field cannot be blank
...
/**
 Use to show error popup.
 */
-(void)showPopupWithMessage:(NSString *)msg;
